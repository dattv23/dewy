...
const features = [
	{
		...
		description:
			'Chiết xuất từ thực vật hữu cơ, an toàn và hiệu quả cho làn da của bạn',
	},
	{
		icon: ShieldCheck,
		title: 'Kiểm Nghiệm Bởi Bác Sĩ Da Liễu',
		description:
			'Tất cả sản phẩm đều được kiểm tra và phê duyệt bởi các bác sĩ da liễu chứng nhận',
	},
	{
		icon: Award,
		title: 'Không Thử Nghiệm Trên Động Vật',
		description:
			'Chúng tôi cam kết không thử nghiệm trên động vật và chỉ sử dụng thành phần thuần chay',
	},
	{
		icon: Sparkles,
		title: 'Hiệu Quả Rõ Rệt',
		description:
			'Thấy sự cải thiện rõ ràng trên làn da chỉ sau 2-4 tuần sử dụng đều đặn',
	},
];
					...
					<div className='grid gap-12 lg:grid-cols-2 lg:gap-16 items-center'>
						<div className='space-y-6 text-center lg:text-left'>
							...
							<p className='text-lg text-muted-foreground leading-relaxed text-pretty max-w-2xl mx-auto lg:mx-0'>
								Trải nghiệm sức mạnh kỳ diệu của thiên nhiên với bộ sưu tập mỹ
								phẩm hữu cơ, chăm sóc da sạch và tự nhiên của chúng tôi. Thành
								phần thuần khiết cho làn da rạng rỡ và khỏe mạnh.
							</p>
				...
				<div className='container mx-auto px-4'>
					<div className='mb-12 text-center space-y-4'>
						...
						<p className='text-lg text-muted-foreground text-pretty max-w-2xl mx-auto'>
							Những sản phẩm làm đẹp tự nhiên được yêu thích nhất cho làn da
							...
							>
								<div className='relative aspect-square overflow-hidden'>
									...
									<Image
										src={
											product.image ||
											'/placeholder.svg?height=400&width=400&query=natural cosmetics product'
										}
										alt={product.name}
										width={300}
										height={300}
			...
			<section className='py-16 md:py-24 bg-gradient-to-br from-muted/50 to-accent/20'>
				<div className='container mx-auto px-4'>
					<div className='mb-12 text-center space-y-4'>
						...
						<p className='text-lg text-muted-foreground text-pretty max-w-2xl mx-auto'>
							Cam kết về làm đẹp sạch, thành phần tự nhiên và sức khỏe làn da
							của bạn
						</p>
					</div>
					...
					<div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-4'>
						{features.map((feature, index) => (
							<Card
								key={index}
								className='text-center border-none shadow-sm bg-card/50 backdrop-blur rounded-2xl'
							>
				...
				<div className='container mx-auto px-4 text-center relative z-10'>
					<div className='mx-auto max-w-3xl space-y-6'>
						...
						<p className='text-lg text-primary-foreground/90 leading-relaxed text-pretty'>
							Các chuyên gia làm đẹp của chúng tôi sẵn sàng giúp bạn tìm sản
							phẩm hoàn hảo cho làn da của bạn. Liên hệ ngay hôm nay để nhận tư
							vấn cá nhân hóa.
						</p>
