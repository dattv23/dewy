							...
							<CardContent className='pt-12 pb-8 text-center space-y-8'>
								...
								<div className='space-y-4'>
									...
									<p className='text-lg text-muted-foreground leading-relaxed text-pretty'>
										Thank you for your order request. We've received your
										information and will send a confirmation email shortly.
									</p>
								</div>
										...
										<div className='flex items-center gap-3'>
											...
											<div className='space-y-1'>
												...
												<p className='text-sm text-muted-foreground leading-relaxed'>
													Please check your email inbox for order confirmation
													and next steps. Be sure to check your spam folder if
								...
								<div className='space-y-3 pt-4'>
									...
									<div className='space-y-2 text-sm text-muted-foreground'>
										...
										<div className='flex items-start gap-3'>
											...
											<p className='text-left leading-relaxed'>
												Our team will review your request and send payment
												instructions
											</p>
										</div>
										<div className='flex items-start gap-3'>
