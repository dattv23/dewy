...
const values = [
	...
	},
	{
		...
		description:
			'Honest communication and transparent business practices are at the core of everything we do.',
	},
];
...
const milestones = [
	{
		...
		description:
			'Started with a mission to make sustainable living accessible to everyone',
	},
	{
		year: '2020',
		title: 'Expanded Catalog',
		description:
			'Grew to over 100 eco-friendly products from trusted sustainable brands',
	},
	{
		year: '2022',
		title: '10,000+ Customers',
		description:
			'Reached a major milestone serving thousands of environmentally conscious customers',
	},
	{
		year: '2024',
		title: 'Carbon Neutral',
		description:
			'Achieved carbon-neutral operations and packaging across our entire business',
	},
];
					...
					<div className='grid gap-12 lg:grid-cols-2 lg:gap-16 items-center'>
						<div className='space-y-6 text-center lg:text-left'>
							...
							<p className='text-xl text-muted-foreground leading-relaxed text-pretty'>
								We're on a mission to make sustainable living easy, accessible,
								and affordable for everyone. Since 2018, we've been helping
								thousands of customers make eco-friendly choices.
							</p>
							<Button
								asChild
								size='lg'
							...
							<CardContent className='pt-12 pb-12 space-y-6'>
								...
								<div className='text-center space-y-4'>
									...
									<p className='text-lg text-muted-foreground leading-relaxed text-pretty max-w-2xl mx-auto'>
										To empower individuals to live more sustainably by providing
										access to high-quality, eco-friendly products that don't
										compromise on style, functionality, or affordability. We
										believe small changes can make a big difference for our
										planet.
									</p>
								</div>
							</CardContent>
			...
			<section className='py-16 md:py-24'>
				<div className='container mx-auto px-4'>
					<div className='mb-12 text-center space-y-4'>
						...
						<p className='text-lg text-muted-foreground text-pretty max-w-2xl mx-auto'>
							From humble beginnings to serving thousands of eco-conscious
							customers
						</p>
					</div>
				...
				<div className='container mx-auto px-4 text-center'>
					<div className='mx-auto max-w-3xl space-y-6'>
						...
						<p className='text-lg text-muted-foreground leading-relaxed text-pretty'>
							Ready to start your sustainable journey? Browse our products or
