...
const allProducts = [
  {
    ...
    description: "Eco-friendly reusable utensils for sustainable dining on the go",
  ...
  },
  {
    ...
    description: "Handcrafted soaps with organic ingredients and essential oils",
...
const categories = ["All", "Kitchen", "Bags", "Drinkware", "Personal Care", "Skincare", "Makeup", "Body Care"]
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-3xl mx-auto text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Explore our full collection of eco-friendly and sustainable products
              </p>
            </div>
          </div>
        </section>
                  ...
                  {filteredProducts.map((product) => (
                    ...
                    >
                      ...
                      <CardContent className="p-5 space-y-3">
                        ...
                        <h3 className="font-semibold text-lg text-foreground text-balance">{product.name}</h3>
        ...
        <section className="py-16 bg-gradient-to-br from-primary/10 via-background to-accent/20">
          <div className="container mx-auto px-4 text-center">
            <div className="mx-auto max-w-2xl space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Contact us to place your order and we'll respond with confirmation details
              </p>
